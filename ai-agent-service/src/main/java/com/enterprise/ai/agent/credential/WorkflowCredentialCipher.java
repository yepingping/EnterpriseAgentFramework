...
@Slf4j
@Component
public class WorkflowCredentialCipher {
    ...
    public WorkflowCredentialCipher(
    ...
    public String encrypt(String plainText) {
        ...
        try {
            ...
            throw new IllegalStateException("Encrypt workflow credential failed", e);
        }
    }
    ...
    public String decrypt(String encryptedText) {
        ...
        try {
            ...
            throw new IllegalStateException("Decrypt workflow credential failed", e);
        }
    }
